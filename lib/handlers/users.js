...
_users.validatePayloadData = function (data, callback) {
      ...
      firstName = typeof(firstName) === 'string' && firstName.trim().length > 2 ? firstName.trim() : false;
      lastName = typeof(lastName) === 'string'  && lastName.trim().length > 2  ? lastName.trim() : false;
