            ...
            _data.read('users', phone, function(err, userData){
                  if(!err && userData){
                        ...
                        if(hashedPass === userData.hashedPassword){
                              ...
                              let tokenId = helpers.createRandomString(config.randomStringLen);
...
_tokens.GET = function (data, callback) {
      ...
      id = typeof id === 'string' && id.trim().length === config.randomStringLen ? id : false;
...
_tokens.DELETE = function (data, callback) {
      ...
      id = typeof id === 'string' && id.length === config.randomStringLen ? id : false;
